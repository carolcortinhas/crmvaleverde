...
describe('Service Tests', () => {
  describe('Gerente Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(GerenteService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Gerente(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Gerente', () => {
        ...
        service.create(new Gerente()).subscribe(resp => (expectedResult = resp.body));
