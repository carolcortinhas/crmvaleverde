...
describe('Service Tests', () => {
  describe('Avaliacao Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(AvaliacaoService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Avaliacao(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Avaliacao', () => {
        ...
        service.create(new Avaliacao()).subscribe(resp => (expectedResult = resp.body));
